...
from .views import whatsapp_form, whatsapp_list,conectar,whatsapp_desconect,whatsapp_delete

urlpatterns = [
    path('whatsappform/', whatsapp_form, name='whatsapp_form'),
    path('whatsapplist/', whatsapp_list, name='whatsapp_list'),
    #path('updateocorrencia/<int:id>', ocorrencia_update, name='updateocorrencia'),
    #path('deleteocorrencia/<int:id>', ocorrencia_delete, name='deleteocorrencia')
